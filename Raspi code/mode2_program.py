...
piston_posities = [
    ...
    {'a': [0.6880, 0.6996, 0.4525, 1.578, 1.369, 4.087], 'b': [0.6880, 0.7426, 0.4525, 1.578, 1.369, 4.087], 'c': [0.6880, 0.7426, 0.4785, 1.578, 1.369, 4.087], 'd': [0.6880, 0.6996, 0.4785, 1.578, 1.369, 4.087]},
    {'a': [0.6838, 0.6534, 0.3945, 1.578, 1.359, 4.087], 'b': [0.6838, 0.6964, 0.3945, 1.578, 1.359, 4.087], 'c': [0.6838, 0.6964, 0.4205, 1.578, 1.359, 4.087], 'd': [0.6838, 0.6534, 0.4205, 1.578, 1.359, 4.087]},
    {'a': [0.6805, 0.6064, 0.3350, 1.578, 1.359, 4.087], 'b': [0.6805, 0.6494, 0.3350, 1.578, 1.359, 4.087], 'c': [0.6805, 0.6494, 0.3610, 1.578, 1.359, 4.087], 'd': [0.6805, 0.6064, 0.3610, 1.578, 1.359, 4.087]},
    {'a': [0.6748, 0.5608, 0.2752, 1.578, 1.359, 4.087], 'b': [0.6748, 0.6038, 0.2752, 1.578, 1.359, 4.087], 'c': [0.6748, 0.6038, 0.3012, 1.578, 1.359, 4.087], 'd': [0.6748, 0.5608, 0.3012, 1.578, 1.359, 4.087]},
]
piston_posities_terug = [
    ...
    {'a': [0.6869, 0.6762, 0.4832, 1.578, 1.359, 4.087], 'b': [0.6869, 0.7192, 0.4832, 1.578, 1.359, 4.087], 'c': [0.6869, 0.7192, 0.5092, 1.578, 1.359, 4.087], 'd': [0.6869, 0.6762, 0.5092, 1.578, 1.359, 4.087]},
    {'a': [0.6814, 0.6265, 0.4232, 1.578, 1.359, 4.087], 'b': [0.6814, 0.6695, 0.4232, 1.578, 1.359, 4.087], 'c': [0.6814, 0.6695, 0.4492, 1.578, 1.359, 4.087], 'd': [0.6814, 0.6265, 0.4492, 1.578, 1.359, 4.087]},
    {'a': [0.6781, 0.5748, 0.3637, 1.578, 1.359, 4.087], 'b': [0.6781, 0.6178, 0.3637, 1.578, 1.359, 4.087], 'c': [0.6781, 0.6178, 0.3897, 1.578, 1.359, 4.087], 'd': [0.6781, 0.5748, 0.3897, 1.578, 1.359, 4.087]},
    {'a': [0.6764, 0.5236, 0.3072, 1.578, 1.359, 4.087], 'b': [0.6764, 0.5666, 0.3072, 1.578, 1.359, 4.087], 'c': [0.6764, 0.5666, 0.3332, 1.578, 1.359, 4.087], 'd': [0.6764, 0.5236, 0.3332, 1.578, 1.359, 4.087]},
]

Approach_Big_rek_1 = [0.5356 , 0.0960 , 0.4850 , 0.0 , 0 , 3.106]
Approach_Big_rek_2 = [0.5050 , -0.413 , 0.4850 , 0.0 , 0 , -4.230]
Approach_Big_rek_3 = [0.0724 , -0.4824 , 0.2538 , 0.166 , -0.058 , -4.721]
...
B = [
    {'a' : [0.1725 , -0.7229 , -0.1311 , 0.287 , - 0.178 , -4.710], 'b' : [0.1725 , -0.9229 , -0.1311 , 0.287 , - 0.178 , -4.710], 'c' : [0.1725 , -0.9229 , -0.1621 , 0.287 , - 0.178 , -4.710],'d': [0.1725 , -0.9229 , -0.1681 , 0.093 , 0.014 , -4.724]},
    {'a' : [0.1666 , -0.7148 , 0.2792 , 0.271 , -0.162 , -4.713], 'b' : [0.1666 , -0.9148 , 0.2792 , 0.271 , -0.162 , -4.713],  'c' : [0.1666 , -0.9148 , 0.2498 , 0.271 , -0.162 , -4.713], 'd' : [0.1666 , -0.9167 , 0.2369 , 0.120 , -0.013 , -4.724]},
    {'a' : [0.1566 , -0.7091 , 0.6927 , 0.240 , -0.104 , -4.717], 'b' : [0.1566 , -0.9091 , 0.6927 , 0.240 , -0.104 , -4.717], 'c' : [0.1566 , -0.9091 , 0.6589 , 0.240 , -0.104 , -4.717], 'd' : [0.1566 , -0.9123 , 0.6391 , 0.143 , -0.009 , -4.724]}]
...
def main():
    ...
    try:
        ...
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_1))
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_2))
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_3))
        rtde_c.moveJ(rtde_c.getInverseKinematics(B_3_1))
        time.sleep(5)
        rtde_c.moveJ(rtde_c.getInverseKinematics(B_3_2))
        time.sleep(5)
        rtde_c.moveJ(rtde_c.getInverseKinematics(B_3_3))
        time.sleep(5)
        rtde_c.setPayload(*payloads['leeg'])
        rtde_c.moveJ(rtde_c.getInverseKinematics(B_3_4))
        rtde_io_inst.setStandardDigitalOut(1, False) 
        rtde_c.moveJ(rtde_c.getInverseKinematics(B_3_1))
        logging.info("Cobot beweegt terug naar startpositie.")
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_3))
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_2))
        rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_1))
        logging.info("Cobot terug naar startpositie.")
        ...
        # --- Hoofd Cyclus ---
            ...
            time.sleep(1)
            rtde_c.moveJ(rtde_c.getInverseKinematics(oppakhoogte))
            rtde_c.setPayload(*payloads['p_20'])  # Stel de payload in voor de pistons
            rtde_c.moveJ(rtde_c.getInverseKinematics(opgepakt))
            rtde_c.moveJ(rtde_c.getInverseKinematics(approach))
            logging.info("Leeg rek opgepakt.")
            
            # 2. Vul het rek, rij voor rij
            pos = piston_posities[4]
            ...
            rtde_c.setPayload(*payloads['p_25'])
            # Beweeg omhoog
            ...
            rtde_c.moveJ(rtde_c.getInverseKinematics(approach))
            logging.info("Rek is vol, nu gaan we het rek draaien.")
            rtde_c.moveJ(rtde_c.getInverseKinematics(Turn_1))
            rtde_c.moveJ(rtde_c.getInverseKinematics(Turn_2))
            logging.info("Rek staat op de juiste positie voor de draai.")
            ...
            logging.info("Rek wordt weer opgepakt")
            ...
            rtde_c.moveJ(rtde_c.getInverseKinematics(approach))
            logging.info("Achterkant van rek wordt nu gevuld.")
            ...
            for i in range(5):
                ...
                time.sleep(1)  # Wacht even om de Arduino tijd te geven om te stoppen
                stuur_arduino_signaal(h, SIGNAAL_PIN, False) # arduino mag door
                logging.info(f"Rij {rij_nummer_terug} met pistons opgepakt.") 
                
            rtde_c.moveJ(rtde_c.getInverseKinematics(approach))
            logging.info("Volle rek wordt naar trolley bewogen.")
            posi = B[n]  # Gebruik de juiste rijpositie uit de B lijst
            rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_1))
            rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_2))
            rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_3))
            rtde_c.moveJ(rtde_c.getInverseKinematics(posi['a']))
            rtde_c.moveJ(rtde_c.getInverseKinematics(posi['b']))
            rtde_c.moveJ(rtde_c.getInverseKinematics(posi['c']))
            logging.info("Rek in trolley neergezet.")
            rtde_c.setPayload(*payloads['leeg'])
            rtde_c.moveJ(rtde_c.getInverseKinematics(posi['d']))
            rtde_io_inst.setStandardDigitalOut(1, False) 
            rtde_c.moveJ(rtde_c.getInverseKinematics(posi['a']))
            logging.info("Cobot beweegt terug naar startpositie.")
            rtde_c.moveJ(rtde_c.getInverseKinematics(Approach_Big_rek_3))
